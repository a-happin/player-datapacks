...
execute if score @s player_data matches 0..32767 if data storage player_data: _[2] run data remove storage player_data: _[2]
execute unless score @s player_data matches 0..32767 unless data storage player_data: _[2] run data modify storage player_data: _ append value []
